  ...
  <!DOCTYPE html>
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <div class="col-xs-9">
            <input type="email" class="form-control" id="inputEmail" placeholder="Razón">
            </div>
            </div>
            ...
            <div class="col-xs-9">
            <input type="email" class="form-control" id="inputEmail" placeholder="Ingrese Nit">
            </div>
            </div>
            ...
            <div class="col-xs-9">
            <input type="tel" class="form-control" placeholder="Contacto">
            </div>
            </div>
            <br></br>
            ...
            <div class="col-xs-9">
            <input type="tel" class="form-control" placeholder="Usuario">
            </div>
            </div>
            <br></br>
            ...
            <div class="col-xs-9">
            <input type="tel" class="form-control" placeholder="Ingresar contraseña">
            </div>
            </div>
            <br></br>
